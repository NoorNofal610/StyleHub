...
export default function ProductDetail() {
  ...
  const handleBuy = () => alert(`تم شراء ${quantity} قطعة من ${product.title}`);
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Box sx={{ flex: '1.2', display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography>
                  We offer complimentary express shipping. Free returns are available worldwide. 
                  If your item is eligible for return, you have 30 days from the date you receive 
                  your order to follow this procedure. See delivery and returns for more information.
                </Typography>
              </AccordionDetails>
            </Accordion>
          </Box>
        ...
        <Drawer anchor="right" open={drawerOpen} onClose={() => setDrawerOpen(false)}>
          <Box sx={{ width: 400, p: 3, position: 'relative' }}>
            ...
            <Typography mb={2}>
              To find out the equivalent sizes by country, please see the grid below.
            </Typography>
